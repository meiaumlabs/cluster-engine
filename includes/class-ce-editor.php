	...
	private static function enqueue( $post_id ) {
		...
		wp_localize_script( 'ce61-editor', 'CE61_EDITOR', array(
			...
			'i18n'        => array(
				...
				'fixBtn'        => __( 'Corrigir', 'cluster-engine' ),
				'fixing'        => __( 'Corrigindo…', 'cluster-engine' ),
				'fixed'         => __( 'Pendência corrigida.', 'cluster-engine' ),
				'fixManual'     => __( 'Sem correção automática — ajuste no editor ou use a geração completa ao lado.', 'cluster-engine' ),
				'fixManualShort' => __( 'No editor', 'cluster-engine' ),
				'fixSelectOne'  => __( 'Selecionar esta pendência', 'cluster-engine' ),
				'fixSelectAll'  => __( 'Selecionar todas', 'cluster-engine' ),
				'fixSelected'   => __( 'Corrigir selecionadas', 'cluster-engine' ),
				'fixSelectNone' => __( 'Selecione ao menos uma pendência para corrigir.', 'cluster-engine' ),
				'fixBatchProgress' => __( 'Corrigindo {n} de {total}…', 'cluster-engine' ),
				'fixBatchDone'  => __( 'Corrigidas {ok}/{total} pendências.', 'cluster-engine' ),
				'fixBatchFails' => __( 'Falhas:', 'cluster-engine' ),
				'metaTitle'     => __( 'Título e meta descrição', 'cluster-engine' ),
				'metaHint'      => __( 'Gere ou edite o meta título e a meta descrição, individualmente. As mudanças são salvas na hora no seu plugin de SEO.', 'cluster-engine' ),
				'metaTitleLabel' => __( 'Meta título', 'cluster-engine' ),
				'metaDescLabel' => __( 'Meta descrição', 'cluster-engine' ),
				'metaGen'       => __( 'Gerar com IA', 'cluster-engine' ),
				'metaGenning'   => __( 'Gerando…', 'cluster-engine' ),
				'metaSave'      => __( 'Salvar', 'cluster-engine' ),
				'metaSaving'    => __( 'Salvando…', 'cluster-engine' ),
				'metaOptsHint'  => __( 'Escolha uma opção para usar:', 'cluster-engine' ),
				'metaNoOpts'    => __( 'A IA não retornou opções. Tente novamente.', 'cluster-engine' ),
				'metaEmpty'     => __( 'Escreva ou gere um valor antes de salvar.', 'cluster-engine' ),
				'metaTitleSaved' => __( 'Meta título salvo.', 'cluster-engine' ),
				'metaDescSaved' => __( 'Meta descrição salva.', 'cluster-engine' ),
				...
				'h2Label'       => __( 'Quantos H2 incluir? (0 = livre)', 'cluster-engine' ),
				'refineBtn'     => __( 'Ajustar melhoria', 'cluster-engine' ),
				'refineHint'    => __( 'Peça um ajuste sobre o rascunho gerado. A IA refina este rascunho (não recomeça do conteúdo original).', 'cluster-engine' ),
				'refinePlaceholder' => __( 'Ex.: deixe a conclusão mais curta, adicione um exemplo prático no 2º tópico e transforme o 3º parágrafo em lista.', 'cluster-engine' ),
				'refineGen'     => __( 'Gerar ajuste', 'cluster-engine' ),
				'refineEmpty'   => __( 'Descreva o ajuste que a IA deve aplicar ao rascunho.', 'cluster-engine' ),
				'backDraft'     => __( 'Voltar ao rascunho', 'cluster-engine' ),
