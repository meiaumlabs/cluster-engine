	...
	private static function enqueue( $post_id ) {
		...
		wp_localize_script( 'ce61-editor', 'CE61_EDITOR', array(
			...
			'i18n'        => array(
				...
				'modalHint'   => __( 'Descreva o que precisa ser atualizado ou melhorado neste conteúdo. A IA mantém o assunto e a base de configuração do site, e usa o conhecimento que já tem para melhorar o texto.', 'cluster-engine' ),
				'placeholder' => __( 'Ex.: atualize os dados para 2026, deixe a introdução mais direta, adicione uma seção de perguntas frequentes e melhore o E-E-A-T.', 'cluster-engine' ),
				'send'        => __( 'Melhorar conteúdo', 'cluster-engine' ),
				'cancel'      => __( 'Cancelar', 'cluster-engine' ),
				'working'     => __( 'A IA está reescrevendo o conteúdo…', 'cluster-engine' ),
				'done'        => __( 'Conteúdo atualizado com IA. Recarregue o editor para ver as alterações.', 'cluster-engine' ),
				'reload'      => __( 'Recarregar editor', 'cluster-engine' ),
				'empty'       => __( 'Descreva o que precisa ser atualizado antes de enviar.', 'cluster-engine' ),
